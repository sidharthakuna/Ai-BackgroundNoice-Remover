"""
engine.py — Neural model registry and cooperative job cancellation manager.
Pre-warms DeepFilterNet3 in RAM to eliminate cold starts, lazy-loads Demucs,
and coordinates cancellation tokens per job.
"""
...
# Limit internal OpenMP/PyTorch thread counts to avoid CPU throttling
...
class ModelRegistry:
    """Manages pre-warmed neural network weights and cooperative cancellation tokens."""
